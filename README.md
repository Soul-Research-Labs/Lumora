...
| `lumora-bitvm`      | BitVM2 bridge: operator, challenger, optimistic verification, 13 Bitcoin L2 adapters                                               |
...
- **BitVM2 bridge** — Optimistic Bitcoin L1 verification via `BitvmBridge`; operator/challenger protocol with bonded assertions, challenge-response, and timeout-based finality; 13 Bitcoin L2/sidechain adapters
...
│   ├── lumora-bitvm/          # BitVM2 bridge: operator, challenger, 13 adapters
